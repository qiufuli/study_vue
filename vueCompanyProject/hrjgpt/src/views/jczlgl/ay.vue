    ...
    <div>
        ...
        <el-header style="background-color:#F5F5F5;">
            <el-breadcrumb separator-class="el-icon-arrow-right" style="line-height:60px">
                ...
                <el-breadcrumb-item>案由维护</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>-->
                ...
                <el-table :data="ay_tableData"  style="width: 100%"  :header-cell-style="{background:'#27B6C7',color:'#ffffff'}">
                    ...
                    <el-table-column label="操作" min-width="30%" align="center">
                        <template slot-scope="scope" align="center">
                            ...
                            <el-button type="primary" size="mini" class="scbtn" @click="del(scope.$index)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
...
import { validator } from "@/common/js/valid";
    export default {
        ...
        methods: {
            ...
            communication(data){
                data.flag = "1";
                $.post("/wh/xxSave", data).then((result) => {           
                    var _res = result.returnData;
                    if (+_res.executeResult == 1) {
                            this.$message({
                                type: "success",
