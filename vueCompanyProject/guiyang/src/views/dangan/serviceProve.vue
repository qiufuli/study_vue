<docs>
	...
	* @author lvlp
	* @desc 证明材料综合查询 查询 （目前已隐藏该目录——181108）
</docs>
<template>
	<div>
		<!--查询 开始  -->
		<div class="query_wrap">
          ...
          <el-col :span="12">
						<el-form-item label="申请日期">
							<date-ass
								:begin.sync="form.sqksrq" :end.sync="form.sqjsrq"
								propBegin="sqksrq" propEnd="sqjsrq"></date-ass>
						</el-form-item>
					</el-col>
				</el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="6">
						<el-form-item label="开具证明类型" prop="kjzmlx" class="width_100">
