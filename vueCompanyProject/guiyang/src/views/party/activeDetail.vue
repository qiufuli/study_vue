		...
		<div v-loading="loading">
			<el-form :model="form" :rules="rules" label-width="37.5%"
				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="报名时间" label-width="25%" required>
							<el-col :span="11">
								<el-form-item label="" prop="bmkssj">
									<el-date-picker v-model="form.bmkssj"
										class="width_100" :editable="false" placeholder="开始"
										type="datetime" @change="changeStartime" :popper-class="noTime"
										:picker-options="timeRange" @focus="selectDatePicker(0)"></el-date-picker>
								</el-form-item>
							</el-col>
								...
								<el-form-item label="" prop="bmjssj">
									<el-date-picker v-model="form.bmjssj"
										class="width_100" :editable="false" placeholder="结束" type="datetime"
										 @change="changeTime" :popper-class="noTime" :picker-options="timeRange"
										 @focus="selectDatePicker(1)"></el-date-picker>
								</el-form-item>
							</el-col>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="举办日期" prop="jbrq" label-width="25%">
							<el-date-picker v-model="form.jbrq" type="datetime"
							:editable="false" class="date_picker" @change="changeJbrime"
							:popper-class="noTime" :picker-options="timeRange" @focus="selectDatePicker(2)"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="24">
						<el-form-item label="web_活动介绍" prop="web_hdjs" label-width="12.5%">
							<vueUEditor @ready="editor" :defaultValue="form.web_hdjs"
							:ueditorConfig="uEditorConfig"></vueUEditor>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="web活动图片" prop="web_hdtplj" label-width="25%">
							<el-input v-show="false" v-model="form.web_hdtplj"></el-input>
							<upload-img
								:canView="false"
								:modeName="modeNameWeb"
								:tipText="adviseText"
								:maxSize="maxSize"
								:clientName.sync="form.web_hdtpkhdmc"
								:serverPath.sync="form.web_hdtplj"
								:serverName.sync="form.web_hdtpfwdmc"></upload-img>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="app_活动介绍" prop="app_hdjs" label-width="12.5%">
							<!--<el-input type="textarea" v-model="form.app_hdjs"></el-input>-->
              <vueUEditor @ready="editorApp" :defaultValue="form.app_hdjs"
							:ueditorConfig="uEditorConfig"></vueUEditor>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
export default {
	...
	data() {
		return {
			...
			rules: {
				hdbt: [{ validator: validator('64, "less", "活动标题", false') }],
	...
	methods: {
		...
		getData() {
			this.loading = true;
			$.get('/gyrcht/rsdldw/rsdldw/dzzhdBjCx', {
				params: { dzzhd_id: this.$route.params.id }
			}).then((res) => {
				Object.assign(this.form, res.returnData.dzzhd);
				this.editorInstance.setContent(this.form.web_hdjs);
				this.editorInstanceApp.setContent(this.form.app_hdjs);
				this.loading = false;
			}).catch(() => {
				this.loading = false;
			});
		...
		postData() {
			...
			postData.web_hdjs = Base64.encode(this.editorInstance.getContent());
			postData.app_hdjs = Base64.encode(this.editorInstanceApp.getContent());
